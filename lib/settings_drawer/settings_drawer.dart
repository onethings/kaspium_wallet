...
class _SettingsSheetState extends ConsumerState<SettingsSheet> with TickerProviderStateMixin {
              ...
              Expanded(
                child: Stack(children: [
                  ListView(
                    ...
                    children: [
                      Container(
                        margin: EdgeInsetsDirectional.only(start: 30, bottom: 10),
                        child: Text(
                          l10n.preferences,
                        ...
                        SingleLineItem(
                          ...
                          onPressed: () async {
                            ...
                            if (walletAuth.isEncrypted) {
                              final notifier = ref.read(walletAuthProvider.notifier);
                              auth = await authUtil.authenticateWithPassword(context, (password) async {
                                try {
                      ...
                      if (!kPlatformIsIOS && network == KaspaNetwork.mainnet && !wallet.isViewOnly) ...[
                        Divider(height: 2, color: theme.text15),
                        DoubleLineItem(
                          heading: l10n.donate,
                          ...
                          onPressed: () {
                            final uri = KaspaUri(
                              address: Address.decodeAddress(kKaspaDevFundAddress),
                            );
                            Sheets.showAppHeightNineSheet(
                              context: context,
                              theme: theme,
